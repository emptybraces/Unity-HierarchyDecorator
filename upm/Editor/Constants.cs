...
namespace HierarchyDecorator
{
	...
	public static class Constants
	{
		...
		public const string SETTINGS_ASSET_PATH = "Assets/HierarchyDecorator_Settings.asset";
		public const string SETTINGS_ASSET_FOLDER = "Assets/";
	...
	// {
		...
		// internal readonly static Texture2D Bannfer = Load<Texture2D>("HierarchyDecoratorLogo");
	// }
	...
	internal static class Style
	{
		...
		public static readonly GUIStyle CenteredSmallLabel;
		public static readonly GUIStyle CenteredLabelRed;
		...
		static Style()
		{
			...
			CenteredSmallLabel = new GUIStyle(EditorStyles.centeredGreyMiniLabel)
			{
				fixedHeight = 0,
				fontSize = 9,
				alignment = TextAnchor.MiddleCenter
			...
			CenteredLabelRed = new GUIStyle(EditorStyles.centeredGreyMiniLabel)
			{
				fixedHeight = 0,
				alignment = TextAnchor.MiddleCenter,
